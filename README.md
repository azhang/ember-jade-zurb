...
Yeoman generator for Ember, Jade, and Zurb Foundation
based on https://github.com/yeoman/generator-ember

The scaffolding tool for Ember.js/Jade/Zurb Foundation apps.
